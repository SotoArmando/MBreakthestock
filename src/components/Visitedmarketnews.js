    ...
    <a className="allsize col   space_between fore_11 pad_r15 hover_b" target='_tab' href={url}>
        ...
        <div className="col    pad_b23 ">
            ...
            <div className="row center space_between allwidth mar_t19">
                <span className="f_0 f400 fore_16  "><span className="fore_green f600">{source} {new Date(datetime * 1000).toLocaleDateString()}</span> <span className="f_0 ls_27 fw400" >{headline}</span>.</span>
            </div>
        </div>
