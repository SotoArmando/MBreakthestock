    ...
    return <div className={"row center corebox_10 mobilecorebox_16  nav"+ (isScrollCero ? " ": " back_2")} style={{ willChange:"opacity" }}>
        <div className="row space_between center bodywidth ">
            <div className="row start items_center allsize">
                <div className={"row corebox_10 mobilecorebox_16 start fore_12 pad_r24 sec_nav" + (isScrollCero ? "": " active")} style={{ width: "unset" }}>
            ...
            <div className="row center allsize" style={{opacity:(isScrollCero ? 1 : 0)}}> 
